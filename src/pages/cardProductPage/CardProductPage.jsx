  ...
  return (
    <div className={styles.cardProductPage}>
      <main className={styles.slideBox}>
        ...
        >
          <SwiperSlide className={styles.slideBig}>
            <img className={styles.slideImg} src={CardBomberSmall1} alt="" />
            <div className={styles.likeBox}>
              <Like active={false} />
            </div>
          </SwiperSlide>
          <SwiperSlide className={styles.slideBig}>
            <img className={styles.slideImg} src={CardBomberSmall2} alt="" />
            <div className={styles.likeBox}>
              <Like active={false} />
            </div>
          </SwiperSlide>
          <SwiperSlide className={styles.slideBig}>
            <img className={styles.slideImg} src={CardBomberSmall3} alt="" />
            <div className={styles.likeBox}>
              <Like active={false} />
            </div>
          </SwiperSlide>
          <SwiperSlide className={styles.slideBig}>
            <img className={styles.slideImg} src={CardBomberSmall4} alt="" />
            <div className={styles.likeBox}>
              <Like active={false} />
            </div>
          </SwiperSlide>
      ...
      <div className={styles.textBox}>
        <h1 className={styles.textTitle}>{products}</h1>
        <div className={styles.textPrice}>{`${products} ₽`}</div>
        ...
        <div className={styles.textCompositionBox}>
          ...
          <div className={styles.textCompositionSmall}>{products}</div>
        </div>
      </div>
    </div>
  );
